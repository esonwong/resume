...
目前就职于广州丹霄信息技术有限公司。担任**企业 AI Agent 平台负责人**、**AI 技术应用负责人**、**前端职能团队（20 人）负责人**。负责公司级 AI Agent 平台从 0 到 1 的架构与建设，建立「AI 生成 + MR/CI 门禁 + 自动化 review」的 AI 研发流水线，推动 AI 在公司各职能业务（市场、产品、测试、HR、法务、数据等）中的规模化落地；同时负责公司项目的前端架构、DevOps 与前端团队建设。
