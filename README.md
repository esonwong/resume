...
目前就职于广州丹霄信息技术有限公司。担任**前端职能团队（20 人）负责人**、**AI 技术应用负责人**、**内部 AI 应用负责人**。负责公司项目的前端架构、DevOps、前端团队建设、前端业务的开发，同时推动公司各职能工作的 AI 技术应用（包括生成 SEO 外链文章、GPT 售后客服等），以及内部 AI 应用的建设与 AI 在项目当中的应用和落地。
...
面向公司各职能团队的企业级 AI 平台，整合**企业 AI 工具**、**企业知识库**和 **Agent** 能力，推动 AI 在公司业务中的落地应用（包括 SEO 外链文章生成、GPT 售后客服等）。基于大语言模型（**LLM**）结合 **RAG** 检索增强构建企业知识库，并以 Agent 编排自动化业务流程。

我负责该平台的整体技术架构、技术选型与核心功能开发。
