...
Vibemate 的移动端产品，延续桌面端优化直播观看体验的能力，面向移动端直播观看场景。我作为项目**技术负责人**，负责移动端技术架构与团队带领，并主导 **AI 相关特性在产品中的落地**：推动 LLM 能力进入直播互动场景，把 AI 从内部工具带到面向用户的产品功能。
...
- Cordova 混合 App
- Electron 桌面程序
- LLM、RAG、Agent（企业 AI 应用）
- LangGraph、DeepAgents、Pi Agent、MCP
- AI 工程化（Claude Code / Codex、AI 生成 + CI 门禁 + 自动化 review 流水线）
- Git
